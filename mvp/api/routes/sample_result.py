...
from mvp.api.schemas.analysis_result import AnalysisResultQuery,AnalysisResult
...
def parse_result(dir_path,project,verison):
    ...
    for py_file in py_files:
        ...
        module = importlib.import_module(f'mvp.api.sample_result_parse.{module_name}')
