from mvp.main import create_app
import uvicorn
import typer
import os
from mvp.api.config.db import init_engine
# from mvp.api.config.config import get_settings
from mvp.api.config.db import meta,Base
...
def main(
    ...
    uvicorn.run("mvp.main:create_app", host=host, port=port, factory=True,reload=reload)
