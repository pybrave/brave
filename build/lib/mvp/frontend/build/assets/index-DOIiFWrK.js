import{r as m,j as e,a as _}from"./index-01VgbQhG.js";import{A as d}from"./index-Z33O97Tx.js";import{f as g}from"./utils-CGZ5nnj9.js";import{T as c,B as n,F as h,S as f}from"./Table-CvEpiXur.js";import"./index-MU_3aXF1.js";import"./index-BvHRdwnV.js";import"./index-b28f2SJB.js";const y=({record:t,plot:a,setHtmlUrl:u,cleanDom:l,resultTableList:o,form:p})=>{const[r,i]=m.useState();return e.jsx(e.Fragment,{children:e.jsx(c,{onChange:l,items:[{key:"1",label:"多样本分析",children:e.jsxs(e.Fragment,{children:[e.jsx(n,{type:"primary",onClick:()=>{a({saveAnalysisMethod:"mutations_gene",moduleName:"circos_plot_mutations",params:{file_path:"/ssd1/wy/workspace2/leipu/leipu_workspace2/output/breseq/OSP-6/data/OSP-6.count"},formDom:e.jsx(e.Fragment,{children:e.jsx(h.Item,{name:"list_files",label:"选择样本",children:e.jsx(f,{mode:"multiple",style:{maxWidth:"20rem"},allowClear:!0,options:o.breseq?o.breseq.map(s=>({label:`${s.sample_name} (${s.content.reference})`,value:`${s.sample_name}#${s.content.annotated_tsv}`})):[]})})}),tableDesc:`
+ 选择样本说明:
...
| "seq_id": "Chr"                            | 突变发生在哪条序列上（例如染色体或质粒）                       |
                ...
                `})},children:"变异统计"})]})}]})})},E=()=>{const[t,a]=m.useState([]),[u,l]=m.useState(!1),o=async()=>{l(!0);const r=await _.get("/api/mutation");console.log(r),l(!1),a(r.data)};m.useEffect(()=>{o()},[]);const p=[{title:"参考基因组",dataIndex:"reference",key:"reference",ellipsis:!0,render:(r,i)=>{var s;return e.jsx(e.Fragment,{children:(s=i==null?void 0:i.content)==null?void 0:s.reference})}}];return e.jsx(e.Fragment,{children:e.jsx(c,{items:[{label:"breseq",key:"breseq",children:e.jsx(d,{appendSampleColumns:p,analysisMethod:[{name:"breseq",label:"breseq",inputKey:["breseq"],mode:"multiple"}],analysisType:"sample",children:e.jsx(y,{})})}]})})};export{E as default};
