import{j as e,B as i,F as t,af as s,T as r,A as l}from"./index-DS9Fhaew.js";const o=({record:a,plot:n})=>e.jsx(e.Fragment,{children:a?e.jsxs(e.Fragment,{children:[e.jsx(i,{onClick:()=>{n({name:"基因预测统计",saveAnalysisMethod:"prokka_txt_plot",moduleName:"prokka_txt_plot",params:{file_path:a.content.txt}})},children:"基因预测统计"}),e.jsx(i,{onClick:()=>{n({moduleName:"genome_circos_plot_gbk",params:{file_path:a.content.gbk},tableDesc:`
...
+ 在基因组图上的意义
    ...
    + 常用于推测复制起点（origin of replication，ori）和终点（terminus，ter）的位置。
        ...
        + ter 附近则从正变负
                ...
                `})},children:"基因组圈图(gbk)"}),e.jsx(i,{onClick:()=>{n({moduleName:"genome_circos_plot_gff",params:{file_path:a.content.gff}})},children:"基因组圈图(gff)"}),e.jsx(i,{onClick:()=>{n({moduleName:"dna_features_viewer_gbk",params:{file_path:a.content.gbk},formDom:e.jsxs(e.Fragment,{children:[e.jsx(t.Item,{label:"REGION_START ",name:"REGION_START",initialValue:1e3,children:e.jsx(s,{})}),e.jsx(t.Item,{label:"REGION_END ",name:"REGION_END",initialValue:1e4,children:e.jsx(s,{})})]}),tableDesc:`
## 关于基因名称注释
+ gff文件
    + 	1522	2661
    + positive strand
...
+ gkb文件
    ...
    + /translation="MSNDYRNSEGYPDPTAG...RYFTEECQEV"
                `})},children:" 基因组区域基因(gbk)"}),e.jsx(i,{onClick:()=>{n({name:"prokka初步功能注释",saveAnalysisMethod:"prokka_annotation",moduleName:"prokka_annotation",params:{file_path:a.content.tsv},tableDesc:`
