import{r as m,j as e,B as n,F as _,S as d,a as g}from"./main-gLSsR9RJ.js";import{A as h}from"./index-BJN7flDJ.js";import{f}from"./utils-D2B0dIuM.js";import{T as c}from"./index-CZkDjHh0.js";import"./index-BaO2DZAD.js";import"./index-CaXusF4h.js";import"./Dropdown-_lWu8YLp.js";import"./index-C0N-NGLH.js";import"./Table-CR7g3HiW.js";import"./addEventListener-CTJtiein.js";import"./Pagination-C_9v4VMr.js";import"./index-BKkflL4l.js";import"./index-CGugvcta.js";import"./index-MIG_kUMZ.js";import"./index-i78tPWpu.js";import"./index-DoeMV2fv.js";import"./index-Cz_1T5Rx.js";import"./UpOutlined-hpn1VrTh.js";import"./index-C11mV772.js";import"./callSuper-kYkVM6ly.js";import"./index-BgWSL6QU.js";import"./index-GGgr4GOW.js";import"./index-B3AoTQEE.js";import"./usePagination-Cdr2dVUM.js";import"./DeleteOutlined-DEO6o0ja.js";import"./index-Cue8n2_k.js";import"./rgb-BwIoVOhg.js";import"./index-B7p8vigH.js";const y=({record:t,plot:a,setHtmlUrl:u,cleanDom:o,resultTableList:l,form:p})=>{const[r,i]=m.useState();return e.jsx(e.Fragment,{children:e.jsx(c,{onChange:o,items:[{key:"1",label:"多样本分析",children:e.jsxs(e.Fragment,{children:[e.jsx(n,{type:"primary",onClick:()=>{a({saveAnalysisMethod:"mutations_gene",moduleName:"circos_plot_mutations",params:{file_path:"/ssd1/wy/workspace2/leipu/leipu_workspace2/output/breseq/OSP-6/data/OSP-6.count"},formDom:e.jsx(e.Fragment,{children:e.jsx(_.Item,{name:"list_files",label:"选择样本",children:e.jsx(d,{mode:"multiple",style:{maxWidth:"20rem"},allowClear:!0,options:l.breseq?l.breseq.map(s=>({label:`${s.sample_name} (${s.content.reference})`,value:`${s.sample_name}#${s.content.annotated_tsv}`})):[]})})}),tableDesc:`
+ 选择样本说明:
...
| "seq_id": "Chr"                            | 突变发生在哪条序列上（例如染色体或质粒）                       |
                ...
                `})},children:"变异统计"})]})}]})})},K=()=>{const[t,a]=m.useState([]),[u,o]=m.useState(!1),l=async()=>{o(!0);const r=await g.get("/api/mutation");console.log(r),o(!1),a(r.data)};m.useEffect(()=>{l()},[]);const p=[{title:"参考基因组",dataIndex:"reference",key:"reference",ellipsis:!0,render:(r,i)=>{var s;return e.jsx(e.Fragment,{children:(s=i==null?void 0:i.content)==null?void 0:s.reference})}}];return e.jsx(e.Fragment,{children:e.jsx(c,{items:[{label:"breseq",key:"breseq",children:e.jsx(h,{appendSampleColumns:p,analysisMethod:[{name:"breseq",label:"breseq",inputKey:["breseq"],mode:"multiple"}],analysisType:"sample",children:e.jsx(y,{})})}]})})};export{K as default};
