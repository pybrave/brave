import{r as m,j as e,B as n,F as _,S as d,a as g}from"./main-DWRmJItp.js";import{A as h}from"./index-DjwZXGu8.js";import{f}from"./utils-D2B0dIuM.js";import{T as c}from"./index-BL5qaRD0.js";import"./index-ByZxpDTB.js";import"./Table-CorKTwZX.js";import"./addEventListener-BBJtVQmZ.js";import"./Dropdown-CRhi--nO.js";import"./index-CRfZL3ek.js";import"./index-CIC2lPJU.js";import"./index-Boe5_PAQ.js";import"./index-CELUfxGL.js";import"./index-CD0H_sEz.js";import"./index-BEHP9AIO.js";import"./index-buf9Du1j.js";import"./UpOutlined-B9ArEpXu.js";import"./index-C6NESaM6.js";import"./index-CJtHLx1t.js";import"./callSuper-Cn0arcAG.js";import"./index-Br9XgThS.js";import"./index-ChbX2kGi.js";import"./index-B1xgCqcU.js";import"./usePagination-BbrBuRX4.js";import"./DeleteOutlined-CQr_HvF4.js";import"./index-vrokRTY_.js";import"./rgb-BwIoVOhg.js";import"./index-CSPO6T1X.js";const y=({record:t,plot:a,setHtmlUrl:u,cleanDom:o,resultTableList:l,form:p})=>{const[r,i]=m.useState();return e.jsx(e.Fragment,{children:e.jsx(c,{onChange:o,items:[{key:"1",label:"多样本分析",children:e.jsxs(e.Fragment,{children:[e.jsx(n,{type:"primary",onClick:()=>{a({saveAnalysisMethod:"mutations_gene",moduleName:"circos_plot_mutations",params:{file_path:"/ssd1/wy/workspace2/leipu/leipu_workspace2/output/breseq/OSP-6/data/OSP-6.count"},formDom:e.jsx(e.Fragment,{children:e.jsx(_.Item,{name:"list_files",label:"选择样本",children:e.jsx(d,{mode:"multiple",style:{maxWidth:"20rem"},allowClear:!0,options:l.breseq?l.breseq.map(s=>({label:`${s.sample_name} (${s.content.reference})`,value:`${s.sample_name}#${s.content.annotated_tsv}`})):[]})})}),tableDesc:`
+ 选择样本说明:
...
| "seq_id": "Chr"                            | 突变发生在哪条序列上（例如染色体或质粒）                       |
                ...
                `})},children:"变异统计"})]})}]})})},H=()=>{const[t,a]=m.useState([]),[u,o]=m.useState(!1),l=async()=>{o(!0);const r=await g.get("/api/mutation");console.log(r),o(!1),a(r.data)};m.useEffect(()=>{l()},[]);const p=[{title:"参考基因组",dataIndex:"reference",key:"reference",ellipsis:!0,render:(r,i)=>{var s;return e.jsx(e.Fragment,{children:(s=i==null?void 0:i.content)==null?void 0:s.reference})}}];return e.jsx(e.Fragment,{children:e.jsx(c,{items:[{label:"breseq",key:"breseq",children:e.jsx(h,{appendSampleColumns:p,analysisMethod:[{name:"breseq",label:"breseq",inputKey:["breseq"],mode:"multiple"}],analysisType:"sample",children:e.jsx(y,{})})}]})})};export{H as default};
